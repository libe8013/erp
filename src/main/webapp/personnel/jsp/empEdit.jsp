...
<div>
    <form id="ff" class="layui-form" method="post" autocomplete="off">
        ...
        <button style="margin-left: 43%; " type="button" lay-filter="empEdit" lay-submit class="layui-btn"  id="empEdit" lay-verify="empEdit">保存</button>

    </form>

</div>
<script src="${ctx}/personnel/js/empEdit.js"></script>
