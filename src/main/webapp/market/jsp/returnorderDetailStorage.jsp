...
<head>
    ...
    <script src="${ctx}/market/js/returnorderDetailStorage.js"></script>
</head>
<body>
...
<script type="text/html" id="storageDiv">
    ...
    <div style="padding-top: 10px;">
        ...
        <div class="layui-inline" style="margin-top: 10px;">
                ...
                <div class="layui-input-inline">
                    <input type="hidden" readonly id="storeuuid" name="storeuuid" autocomplete="off" class="layui-input">
                    <input type="text" readonly id="storename" name="storename" autocomplete="off" class="layui-input">
        ...
        <div class="layui-inline" style="margin-top: 15px;margin-left: 40%;">
            <a class="layui-btn" lay-submit lay-filter="Storage" id="delStorage">入库</a>
        </div>
    </div>
    </form>
</script>
