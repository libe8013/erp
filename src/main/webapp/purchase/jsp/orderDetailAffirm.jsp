...
<head>
    ...
    <script src="${ctx}/purchase/js/orderDetailAffirm.js"></script>
</head>
<body>
...
<script type="text/html" id="Affirm">
    <button class="layui-btn layui-btn-normal layui-btn-sm" id="OrdersAffirm" lay-event="OrderDetailAffirm">确认</button>
</script>
</body>
</html>
